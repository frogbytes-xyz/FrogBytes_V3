...
export async function GET() {
  try {
    ...
    const totalResponseTime =
      uploadHealth.responseTime +
      transcribeHealth.responseTime +
      summarizeHealth.responseTime +
      pdfHealth.responseTime
